...
('Esmorzar', 'Esmorzar sense queixes el que hi hagi', 'mati', 10, 3, -5, FALSE, '🥣', 10),
('Roba', 'Vestir-se de forma autònoma i sense queixes', 'mati', 10, 3, -5, FALSE, '👗', 20),
('Pentinar', 'Pentinar-se sense posar problemes', 'mati', 10, 3, -5, FALSE, '💇', 30),
('Horari', 'Estar preparada a l''hora per sortir cap a l''escola', 'mati', 10, 3, -5, FALSE, '⏰', 40),
('Sortida escola', 'Sortir sense queixes, crits ni plorar', 'tarda', 10, 3, -5, FALSE, '🏫', 50),
('Motxilla', 'Desfer la motxilla i preparar la del dia següent de forma autònoma', 'tarda', 10, 3, -5, FALSE, '🎒', 60),
('Dutxa', 'Dutxar-se quan toca, de forma autònoma i sense queixes', 'nit', 10, 3, -5, FALSE, '🚿', 70),
('Sopar', 'Sopar correctament, menjant una quantitat mínima dels plats principals', 'nit', 10, 3, -5, FALSE, '🍽️', 80),
('Conte', 'Escollir contes sense conflictes i escoltar', 'nit', 10, 3, -5, FALSE, '📚', 90),
('Dents i logopeda', 'Rentar-se les dents i fer els exercicis de logopèdia', 'nit', 10, 3, -5, FALSE, '🦷', 100),
('Esport de força', 'Fer exercici de força al matí', 'cap_de_setmana', 10, 3, -5, TRUE, '💪', 110),
('Esport en general', 'Fer esport (bici, esquí, excursió...)', 'cap_de_setmana', 10, 3, -5, TRUE, '🚴', 120)
